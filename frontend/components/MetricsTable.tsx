...
export default function MetricsTable({
  ...
  const getScoreBadge = (score: number, threshold: { good: number; fair: number }) => {
    if (score >= threshold.good) {
      return <Badge className="bg-black text-white dark:bg-white dark:text-black">Excellent</Badge>
    } else if (score >= threshold.fair) {
      return <Badge className="bg-black text-white dark:bg-white dark:text-black">Good</Badge>
    } else {
      return <Badge className="bg-black text-white dark:bg-white dark:text-black">Needs Improvement</Badge>
    }
  }
      ...
      metrics: [
        ...
        },
        {
          ...
          badge: metrics.cross_domain_drop <= 0.2 ? 
            <Badge className="bg-black text-white dark:bg-white dark:text-white">Low</Badge> :
            metrics.cross_domain_drop <= 0.4 ?
            <Badge className="bg-black text-white dark:bg-white dark:text-white">Medium</Badge> :
            <Badge className="bg-black text-white dark:bg-white dark:text-black">High</Badge>,
        ...
        },
        {
          ...
          badge: metrics.ece <= 0.1 ? 
            <Badge className="bg-black text-white dark:bg-white dark:text-black">Well Calibrated</Badge> :
            <Badge className="bg-black text-white dark:bg-white dark:text-white">Fair</Badge>,
                      ...
                      .map(([className, classMetrics]) => (
                        <TableRow key={className}>
                          ...
                          <TableCell className="font-mono">
                            <span className={cn(
                              "px-2 py-1 rounded",
                              classMetrics.f1 >= 0.8 ? "bg-black text-white dark:bg-white dark:text-black" :
                              classMetrics.f1 >= 0.6 ? "bg-black text-white dark:bg-white dark:text-black" :
